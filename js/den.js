...
const Den = (() => {
  ...
  function press(x, y) {
    ...
    if (s.key === 'tv') {
      Audio.play('click');
      UI.toast(U.pick(['a nature show about wombats. you have seen this one.', 'the cooking channel. someone is making pumpkin soup.', 'the weather says sunny, with a chance of wombats.']));
      return;
    }
