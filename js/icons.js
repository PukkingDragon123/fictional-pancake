...
const Icons = (() => {
  ...
  const DEF = {
    ...
    // --- tools: wooden handles, steel heads, held on the diagonal ---
    t_drag: (d) => { d.E(8.5, 10.5, 4.6, 4, K3); d.E(4.4, 6.4, 1.8, 2.4, K3); d.E(7, 5, 1.8, 2.6, K3); d.E(9.8, 5.2, 1.8, 2.6, K3); d.E(12.6, 7.2, 1.8, 2.4, K3); d.E(8.5, 11, 2.4, 1.8, '#c98a6c'); d.R(4, 12, 9, 1.4, K2); },
    t_food: (d) => { d.E(8, 11.5, 6.6, 3.2, '#a86f2c'); d.E(8, 10.4, 6, 2.6, '#c98b3f'); d.E(8, 9.6, 5, 1.8, '#5c3d18'); d.E(5.6, 7.6, 2.6, 2.2, M2); d.E(8.6, 6.6, 2.8, 2.4, M3); d.E(11, 7.8, 2.2, 1.9, M4); d.E(8.6, 5.9, 1, 0.9, G3); d.E(5.8, 6.8, 1, 0.8, M4); },
    t_sickle: (d) => { d.L(2, 14, 6, 10, K2, 3); d.L(3, 14, 6, 11, K3, 1); d.R(5, 9, 3, 3, G1); for (let i = 0; i < 8; i++) { const a = -1.2 + i * 0.36; d.R(9 + Math.cos(a) * 5, 8 + Math.sin(a) * 5, 2.4, 2.4, S3); d.R(9.4 + Math.cos(a) * 3.4, 8.4 + Math.sin(a) * 3.4, 1.2, 1.2, S4); } d.R(12, 2, 2, 2, C); },
    t_destroy: (d) => { d.R(3, 6, 10, 7, K2); d.R(3, 6, 10, 2, K3); d.R(7.4, 6, 1.4, 7, K1); d.R(3, 12, 10, 1, K1); d.E(2, 11, 2, 1.6, '#2a1c22'); d.E(4.4, 12.6, 1.6, 1.3, '#2a1c22'); d.R(1, 10, 1, 1, I); d.R(1.4, 8.6, 1, 1.4, I); d.L(0.6, 12, 2.4, 10, I, 1); d.R(1, 14, 14, 1.2, E3); },
    t_pair: (d) => { d.E(5, 8, 3.6, 3.6, R2); d.E(11, 8, 3.6, 3.6, R3); d.E(4.4, 7, 1.2, 1.2, C); d.E(10.4, 7, 1.2, 1.2, C); d.R(7, 7, 2, 2, R3); d.R(3, 12.4, 10, 1.2, K2); },
    t_hoe: (d) => { d.L(2, 14, 10, 6, K2, 3); d.L(3, 14, 10, 7, K3, 1); d.R(8, 4, 6, 3, S3); d.R(12, 4, 2, 7, S3); d.R(8, 4, 6, 1.2, S4); d.R(12, 4, 1, 7, S4); d.R(9, 6, 4, 1, S2); },
    t_seed: (d) => { d.R(4, 4, 8, 10, PAL.parch0); d.R(4, 4, 8, 3, M3); d.R(4, 4, 8, 1, M4); d.R(5, 8, 6, 4, '#3a2c22'); d.E(8, 10, 2, 1.6, K3); d.E(7, 9.4, 0.8, 0.8, M4); d.R(4, 13, 8, 1, PAL.boneD); for (let i = 0; i < 4; i++) d.R(4 + i * 2, 3, 1, 1, PAL.parch0); },
    t_moss: (d) => { d.R(2, 12, 12, 3, E2); d.R(2, 12, 12, 1, E3); for (let i = 0; i < 6; i++) { const x = 3 + i * 2; d.R(x, 6 + (i % 2), 1, 6, M2); d.R(x + 1, 4 + (i % 3), 1, 6, M3); d.R(x, 4 + (i % 3), 1, 1, M4); } },
    t_water: (d) => { d.R(3, 7, 8, 7, '#5f7fa8'); d.R(3, 7, 8, 1.4, '#8fb0d8'); d.R(3, 12.6, 8, 1.4, '#3a5474'); d.L(11, 8, 15, 4, '#5f7fa8', 2); d.R(13, 3, 3, 2, '#8fb0d8'); d.R(4, 4, 5, 3, '#5f7fa8'); d.R(4, 4, 5, 1, '#8fb0d8'); for (let i = 0; i < 3; i++) d.R(14 + (i % 2), 6 + i * 2, 1, 1.6, W3); },
    t_farm: (d) => { d.L(2, 14, 8, 8, K2, 3); d.R(6, 5, 6, 3, S3); d.R(10, 5, 2, 6, S3); d.R(6, 5, 6, 1, S4); d.R(1, 12, 14, 3, E2); d.R(1, 12, 14, 1, E3); d.R(12, 8, 1, 4, M2); d.E(12.5, 7, 1.8, 1.2, M3); },
