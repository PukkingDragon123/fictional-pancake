...
const FURNITURE = [
  { key: 'bench',   name: 'Log Bench',     cost: 90,   w: 56, h: 26, hap: 0.10, blurb: 'Split log on two rounds. Somewhere to sit and watch them.' },
  { key: 'table',   name: 'Trestle Table', cost: 140,  w: 60, h: 34, hap: 0.08, blurb: 'Two trestles and a top. Every wood needs one.' },
  { key: 'lantern', name: 'Post Lantern',  cost: 180,  w: 20, h: 60, hap: 0.14, light: 1, blurb: 'A candle in a box on a post. Burns all night.' },
  ...
  { key: 'firepit', name: 'Fire Pit',      cost: 350,  w: 48, h: 24, hap: 0.22, light: 1, blurb: 'A ring of stones and a heap of ash. Sit round it.' },
  { key: 'shrine2', name: 'Bird Box',      cost: 900,  w: 30, h: 56, hap: 0.14, blurb: 'A little house on a pole. Somebody always moves in.' },
  // the Captain's own stock: the good stuff, from the good ships
  { key: 'ottoman', name: 'Velvet Ottoman',    cost: 150, w: 40, h: 24, hap: 0.14, blurb: 'Red velvet, gold feet, deep buttons. The name of the shop.' },
  { key: 'pouf',    name: 'Knitted Pouf',      cost: 80,  w: 28, h: 20, hap: 0.08, blurb: 'Hand-knitted by the Captain on the long night watches.' },
  { key: 'armchair', name: "Captain's Armchair", cost: 380, w: 44, h: 44, hap: 0.18, blurb: 'Green leather wingback. Smells faintly of pipe and sea.' },
  { key: 'sofa',    name: 'Chesterfield Sofa',  cost: 620, w: 80, h: 40, hap: 0.24, blurb: 'Oxblood leather, a hundred buttons. Three wombats wide.' },
  { key: 'rug',     name: 'Persian Rug',       cost: 260, w: 84, h: 16, hap: 0.12, flat: 1, blurb: 'Came off a ship from somewhere warm. Lies flat on the grass.' },
  { key: 'lamp',    name: 'Standard Lamp',     cost: 210, w: 22, h: 64, hap: 0.10, light: 1, blurb: 'Fringed shade, brass pole. Glows at night.' },
  { key: 'shelf',   name: 'Bookshelf',         cost: 300, w: 44, h: 60, hap: 0.10, blurb: 'Stuffed with sea charts and paperbacks with no ends.' },
  { key: 'hammock', name: 'Rope Hammock',      cost: 340, w: 80, h: 40, hap: 0.20, blurb: 'Two posts and a net. A wombat will fall asleep in it.' },
