...
// is a garden somebody loves.
const PAL = {
  ink: '#1a110b', ink2: '#33241a',
  stone0: '#2c2622', stone1: '#4a413a', stone2: '#6e645a', stone3: '#9a8e82', stone4: '#c8bcae',
  bone: '#ecdcc0', boneD: '#c4ab8a', ash: '#a8a096', ashD: '#7a7066', dust: '#8c8070',
  ...
  soil0: '#3a2414', soil1: '#5c3a20', soil2: '#82563a', soil3: '#aa7a4c', soil4: '#d4a468',
  bark0: '#2e1d12', bark1: '#4c3320', bark2: '#704c2e', bark3: '#9c6d45',
  gold0: '#7a4c06', gold1: '#bd8410', gold2: '#efb625', gold3: '#ffd95c', gold4: '#fff3b8',
  div0: '#4a1e2a', div1: '#8a3a4a', div2: '#c85a66', div3: '#f08a86', div4: '#ffb8a8', div5: '#ffeade',
